    ...
    <main className="container mx-auto p-4 max-w-4xl">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p>
            The Geolocation API allows web applications to access the user's geographical location information, enabling
            location-aware features similar to native apps.
          </p>
          ...
          <p className="text-sm text-muted-foreground">
            Note: Geolocation requires user permission and a secure context (HTTPS). The accuracy may vary depending on
