          ...
          <TabsContent value="json" className="space-y-4 mt-4">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input value={jsonContent.name} onChange={(e) => updateJsonField("name", e.target.value)} />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium">Email</label>
                    <Input value={jsonContent.email} onChange={(e) => updateJsonField("email", e.target.value)} />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateJsonField("preferences.fontSize", Number.parseInt(e.target.value))}
                    />
                  </div>
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
                ...
                <Button
                  onClick={() => downloadFile(JSON.stringify(jsonContent, null, 2), jsonFileName, "application/json")}
                  className="flex items-center"
                >
                  <Download className="mr-2 h-4 w-4" />
                  Download
    ...
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <Card>
            ...
            <CardFooter className="flex justify-between">
              <div className="flex gap-2">
                <Button variant="outline" onClick={openTextFile} className="flex items-center">
              ...
              <Button onClick={saveTextFile} className="flex items-center">
        ...
        <TabsContent value="json" className="space-y-4 mt-4">
          <Card>
            ...
            <CardFooter className="flex justify-between">
              <div className="flex gap-2">
                <Button variant="outline" onClick={openJsonFile} className="flex items-center">
                  <FolderOpen className="mr-2 h-4 w-4" />
                  Open File
                </Button>
                {jsonFileHandle && (
              ...
              <Button onClick={saveJsonFile} className="flex items-center">
                <Save className="mr-2 h-4 w-4" />
                Save File
              </Button>
            </CardFooter>
      ...
      <div className="rounded-md bg-muted p-4">
        ...
        <p className="text-sm text-muted-foreground">
          This example demonstrates using the File System Access API to read and write files directly from the user's
          file system. This API provides a secure way for web applications to interact with the local file system,
          enabling capabilities previously only available to native applications.
        </p>
        <p className="text-sm text-muted-foreground mt-2">The File System Access API allows web applications to:</p>
        ...
        <p className="text-sm text-muted-foreground mt-2">
          For browsers that don't support the File System Access API, this example falls back to using the traditional
          File API with download/upload functionality.
        </p>
      </div>
    </div>
  )
