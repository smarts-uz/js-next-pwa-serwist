...
export default function NetworkStatus({ className }: NetworkStatusProps) {
  ...
  return (
    <Card className={cn("border-l-4", isOnline ? "border-l-green-500" : "border-l-amber-500", className)}>
        ...
        {isOnline ? (
          <>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">All features are available</p>
            </div>
          </>
        ) : (
          <>
