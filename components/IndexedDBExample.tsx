  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-md bg-muted p-4">
        ...
        <p className="text-sm text-muted-foreground">
          This example demonstrates using IndexedDB to create a fully functional
          notes app that works offline. IndexedDB is a low-level API for
          client-side storage of significant amounts of structured data,
          including files and blobs. Unlike localStorage, it's asynchronous and
          can handle much larger amounts of data.
        </p>
        <p className="text-sm text-muted-foreground mt-2">
          The app creates an object store for notes, with indexes for efficient
          querying. All operations (create, read, update, delete) are performed
          directly on the database, allowing the app to work even when offline.
          Changes persist across browser sessions and page reloads.
        </p>
      </div>
    </div>
  );
